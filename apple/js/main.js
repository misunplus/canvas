    ...
    const sceneInfo = [{
        ...
        },
        {
            ...
            values: {
                videoImageCount: 131,
                imageSequence: [0, 130],
                cavas_opacity_in: [0, 1, {
                    start: 0,
                    end: 0.1
                }],
                cavas_opacity_out: [1, 0, {
                    start: 0.95,
                    end: 1
                }],
                messageA_translateY_in: [20, 0, {
                ...
                pinB_opcitiy_out: [0, 1, {
                    start: 0.58,
                    end: 0.63
                }],
                pinC_opcitiy_out: [0, 1, {
                    start: 0.85,
                    end: 0.9
                }],
            }
        ...
        switch (currentScene) {
            ...
            case 2:
                ...
                if (scrollRatio > 0.9) {
                    ...
                    //innerWidth는 스크롤바의 값가지 포함 사용불가능
            ...
            case 3:
                ...
                if (!values.rectStartY) {
                    ...
                    // 스크롤 속도에 따라 값이 변경됨
                    // values.rectStartY = objs.canvas.getBoundingClientRect().y;

                    //offsetTop을 하면 문서 처음 시작부터의 높이가 나온다
                    //지금 섹션의 시작점부터 offseTop값을 가져올수 있다.
                    // 켄바스의 부보 속성을(section) realteve

                    //캔바스의 스케일이 조절되어있어서 값이 맞지 않는다.
                ...
                //sticky 에 fiexd를 줘도 값이 맞지 않는다.. 스케일을 조절했기 때문에..
                //조절한 비율을 얻어 top값을 조절해줘야한다
                //
